...
})({"4dmWh":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = 1234;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d751713988987e9331980363e24189ce";
module.bundle.HMR_BUNDLE_ID = "773c5773532ac83dbc6dc7ddb5532d4d";
// @flow
...
},{}],"47Twn":[function(require,module,exports) {
...
var _reconnectingWebsocketDefault = _parcelHelpers.interopDefault(_reconnectingWebsocket);
var _el = require('./el');
var _elDefault = _parcelHelpers.interopDefault(_el);
var _events = require('./events');
var _eventsDefault = _parcelHelpers.interopDefault(_events);
...
class App {
  constructor(mode) {
    ...
    this.$addButton = new _elDefault.default('#add');
    this.$error = new _elDefault.default('#error');
    this.$drop = new _elDefault.default('#drop');
    this.dragTimeout;
    ...
    this.colors = ['color1', 'color2', 'color3', 'color4', 'color5', 'color6', 'color7', 'color8'];
  ...
  connect(callback) {
    ...
    log('WS URL:', wsUrl);
    this.ws = new _reconnectingWebsocketDefault.default(wsUrl);
  ...
  onButtonClick(event) {
    ...
    if (event.target.className === 'share' && !Clipboard.isSupported()) {
      this.openButtonUrl(event.target);
      // No clipboard support.
      return;
    }
  ...
  record(id, event) {
    ...
    const $el = new _elDefault.default(event.target);
  ...
  removeButton(event, id) {
    ...
    const $button = new _elDefault.default(`#btn-${id}`);
    $button.remove();
    this.send({
      type: 'removeButton',
      channel: this.channel,
...
(function (global, factory) {
  ...
  */
  ...
  var oldInputVal;
  // IE11 workaround, see #1109 for details
...
},{}],"6tJWj":[function(require,module,exports) {
'use strict';
...
},{}],"3Y1ws":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
class El {
  constructor(element) {
