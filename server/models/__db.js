...
async function connectToDatabase() {
  ...
  try {
    ...
    console.error('Failed to connect to MongoDB using native driver. Error object:', err); // Modified log
    process.exit(1);
  }
}
...
function getDb() {
  if (!dbInstance) {
    ...
    console.error('Database not initialized. Ensure connectToDatabase() is called on startup.');
